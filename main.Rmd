...
The following figures (from Figure \@ref(fig:TrcE0eW) to Figure \@ref(fig:budgetE3eA)) present the cumulative bedload transported, deposited and sediment budget over the 10-year period for each equation and trap efficiency scenario.
